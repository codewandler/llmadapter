...
var descriptors = []Descriptor{
	...
	},
	{
		...
		Capabilities:      router.CapabilitySet{Streaming: true, Tools: true, Vision: true, JSONMode: true, JSONSchema: true, Reasoning: true, ReasoningDeltas: true, PromptCaching: true},
		DefaultAPIKeyEnvs: []string{"OPENAI_API_KEY", "OPENAI_KEY"},
