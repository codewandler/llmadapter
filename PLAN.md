...
Important remaining test gaps: deeper endpoint-codec conformance, broader citation variants, additional provider-specific error variants as new providers expose them, full audio/video/file/document/built-in-tool provider conformance, and deeper provider-specific extension semantic validation.
