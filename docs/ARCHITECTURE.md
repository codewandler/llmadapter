...
- Anthropic-family beta/context-management controls. Typed beta and raw context-management helpers are implemented through `unified.AnthropicExtensions`; modeldb-resolved adaptive-effort metadata maps canonical effort into adaptive thinking plus provider `output_config.effort`.
