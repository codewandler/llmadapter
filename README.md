...
Best-effort provider mappings may emit canonical warning events when unsupported fields are dropped; collected responses expose these under `Response.Warnings`.
